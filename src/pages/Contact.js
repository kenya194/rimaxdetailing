          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="card text-center">
                ...
                <a href="tel:+233243877058" className="btn-primary w-full sm:w-auto">
                  Call Now
                </a>
              </div>
              ...
              <div className="card text-center">
                ...
                <p className="text-gray-600 mb-4">+233 24 387 7058</p>
                <a href="https://wa.me/+233243877058" target="_blank" rel="noopener noreferrer" className="btn-secondary bg-green-600 hover:bg-green-700 w-full sm:w-auto">
                  Chat Now
                </a>
              </div>
            </div>
      ...
      <section className="section-padding bg-gradient-to-br from-sunrise-gold/12 via-ocean-blue/10 to-fresh-green/12 relative overflow-hidden">
        ...
        <div className="container-custom text-center relative z-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <button type="button" aria-label="Facebook" className="w-12 h-12 bg-ocean-blue text-white rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors cursor-default" disabled>
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </button>
            <button type="button" aria-label="Instagram" className="w-12 h-12 bg-ocean-blue text-white rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors cursor-default" disabled>
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.708 13.744 3.708 12.447s.49-2.448 1.418-3.323c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.928.875 1.418 2.026 1.418 3.323s-.49 2.448-1.418 3.244c-.875.807-2.026 1.297-3.323 1.297zm7.83-9.781c-.49 0-.928-.175-1.297-.49-.368-.315-.49-.753-.49-1.243 0-.49.122-.928.49-1.243.369-.315.807-.49 1.297-.49s.928.175 1.297.49c.368.315.49.753.49 1.243 0 .49-.122.928-.49 1.243-.369.315-.807.49-1.297.49z"/>
              </svg>
            </button>
            <button type="button" aria-label="Twitter" className="w-12 h-12 bg-ocean-blue text-white rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors cursor-default" disabled>
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
